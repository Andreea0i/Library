    ...
    private class SaveButtonListener implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
            ...
            if (title.isEmpty() || author.isEmpty()) {
                ...
                if (savedBook) {
                    bookView.addDisplayAlertMessage("Save Successful", "Book Added", "Book was uccessfully added to the database.");
        ...
        public void handle(ActionEvent event) {
          ...
          if (bookDTO != null) {
              ...
              if (deletionSuccessful) {
                  ...
                  bookView.addDisplayAlertMessage("Delete Error", "Problem at deleting book", "There was a problem from the database. Please try again");
              }

          } else {
              bookView.addDisplayAlertMessage("Delete Error", "Problem at adeleting a book", " You must select a book before pressing the delete button.");
